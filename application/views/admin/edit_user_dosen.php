	...
	<div class="row">
      	<div class="col-lg-12">
        	...
        	<ol class="breadcrumb">
          		...
          		<li><i class="fa fa-pencil-square-o"></i> Edit Dosen</li>
        	</ol>
      	</div>
    </div><!-- /.row -->
    <div class="row">
		<div class="col-lg-offset-2 col-lg-8 column">
			<div class="panel panel-primary">
            	<div class="panel-heading">
            		<h3 class="panel-title"><center>Edit Dosen</center></h3>
              	</div>
              	<div class="panel-body">
                	<form action="<?php echo base_url(); ?>edit_dosen/edit_data" method="post" class="form-horizontal" role="form">
                		<br>
						<?php 
							if ($new_data['msg'] != '') {
								echo $new_data['msg'];
                		...
                		<div class="form-group">
							...
							<div class="col-sm-9">
								<input type="hidden" name="id" value="<?php echo $data['dosen_id']; ?>">
