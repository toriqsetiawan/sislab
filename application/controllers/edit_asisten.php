...
class Edit_asisten extends CI_Controller {
    ...
    private function user_edit($data)
    {
        ...
        $this->load->view('admin/edit_user_asisten', array('new_data' => $new_data, 'data' => $data));
        $this->load->view('admin/footer');
    }

    private function get_data_asisten($id)
    {
        $this->load->model('user_model');
        $data = $this->user_model->get_asisten($id);
        return $data;
    }
}
?>